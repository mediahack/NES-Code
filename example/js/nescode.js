...
function NESCode( settings ){ 
	...
	this.scriptHost = "http://nescode.googlecode.com/files/";
	...
	**/
	...
	{ 
		...
		var src2 = document.getElementById("_30lives_src2") || document.createElement("source");
			...
			src2.src = "audio/Contra_G_Probotector_StageComplete.ogg";
		...
		emb.width = 100;
		emb.height = 50;
		emb.src = "audio/Contra_G_Probotector_StageComplete.mp3";
